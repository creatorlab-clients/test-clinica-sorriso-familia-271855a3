/* ==========================================================
   Clinica Sorriso Familia — script.js
   Scroll animation (medical-clean 151 frame, cover §4.2)
...
(function () {
  ...
  if (canvas && section) {
    ...
    var FRAME_PATH = 'https://8ispuxmgjxgu2r5q.public.blob.vercel-storage.com/templates/dentisti-001/frames/';
    var FRAME_COUNT = 151;
    ...
    function setupCanvas() {
      ...
      var cw = pin.clientWidth; var ch = pin.clientHeight;
    ...
    function render(progress) {
      ...
      var dw = iw * scale; var dh = ih * scale;
    ...
    for (var i = 1; i <= FRAME_COUNT; i++) {
      var img = new Image(); var num = String(i);
      while (num.length < FRAME_PAD) num = '0' + num;
      img.src = FRAME_PATH + FRAME_PREFIX + num + FRAME_EXT;
      img.onload = function () { loaded++; if (loaded === 1) { setupCanvas(); onScroll(); } };
      images.push(img);
    }
